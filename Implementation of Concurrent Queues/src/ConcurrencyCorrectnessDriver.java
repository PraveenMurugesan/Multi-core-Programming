...
public class ConcurrencyCorrectnessDriver {
    ...
    public static boolean testCorrectness(ConcurrentUnboundedQueueInterface concurrentUnboundedQueueInterface, int nThreads, int nOps) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while (algo <= 2) {
            ...
            boolean check = testCorrectness(concurrentQueue, noOfThreads, noOfOperations);
