...
public class PerformanceDriver {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if (args.length < 4) {
            ...
            System.out.println("format: <test-flavor> <number of threads> <no-of-operations> <print-console-output>");
        ...
        /*System.out.println("Lock based");
         ConcurrentUnboundedQueueInterface concurrentUnboundedQueueInterface = new ConcurrentUnboundedQueueLockBased();
         ...
         concurrentUnboundedQueueInterface = new ConcurrentUnboundedQueueLockFree();
         concurrentUnboundedQueueInterface.enque(1, 100);
         System.out.println(concurrentUnboundedQueueInterface.deque().getKey());*/
        int algo = ALGO_ITER;
